...
public:
	...
	void DrawPrintText(const wchar_t *text, int textLen, FontDrawType_t drawType = FONT_DRAW_DEFAULT) {
		...
		Utils::GetVFunc<Fn>(this, 28)(this, text, textLen, drawType);
	}
	void DrawUnicodeChar(wchar_t wch, FontDrawType_t drawType = FONT_DRAW_DEFAULT) {
		typedef void(__thiscall* Fn)(void*, wchar_t, FontDrawType_t);
		Utils::GetVFunc<Fn>(this, 29)(this, wch, drawType);
	}
	...
	void LockCursor() {
		typedef void(__thiscall* Fn)(void*);
		Utils::GetVFunc<Fn>(this, 67)(this);
	}
	...
	bool SetFontGlyphSet(HFont font, const char *windowsFontName, int tall, int weight, int blur, int scanlines, int flags, int nRangeMin = 0, int nRangeMax = 0) {
		...
		return Utils::GetVFunc<Fn>(this, 72)(this, font, windowsFontName, tall, weight, blur, scanlines, flags, nRangeMin, nRangeMax);
	}
	...
	void GetTextSize(HFont font, const wchar_t *text, int &wide, int &tall) {
		...
		Utils::GetVFunc<Fn>(this, 79)(this, font, text, wide, tall);
	}
